...
def main():
    train = pd.read_csv(
        "https://raw.githubusercontent.com/rh-aiservices-bu/fraud-detection/refs/heads/main/data/train.csv"
    )
    test = pd.read_csv(
        "https://raw.githubusercontent.com/rh-aiservices-bu/fraud-detection/refs/heads/main/data/test.csv"
    )
    valid = pd.read_csv(
        "https://raw.githubusercontent.com/rh-aiservices-bu/fraud-detection/refs/heads/main/data/validate.csv"
    )
    ...
    user_purchase_history.to_csv("raw_transaction_datasource.csv")
