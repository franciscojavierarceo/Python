...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_STREAMFEATUREVIEWSPEC_TAGSENTRY']._loaded_options = None
  _globals['_STREAMFEATUREVIEWSPEC_TAGSENTRY']._serialized_options = b'8\001'
  _globals['_STREAMFEATUREVIEWSPEC'].fields_by_name['user_defined_function']._loaded_options = None
